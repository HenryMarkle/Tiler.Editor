...
void main() {
    ...
    public void Encode()
    {
        ...
        for (int l = Layers.Length - 1; l >= 0; l--)
        {
            ...
            quad = new Quad(
                topLeft:     new(quad.BottomLeft.X, Final.Height - quad.BottomLeft.Y),
                topRight:    new(quad.BottomRight.X, Final.Height - quad.BottomRight.Y),
                bottomRight: new(quad.TopRight.X, Final.Height - quad.TopRight.Y),
                bottomLeft:  new(quad.TopLeft.X, Final.Height - quad.TopLeft.Y)
            );
